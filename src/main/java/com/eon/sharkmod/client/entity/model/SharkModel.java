...
public class SharkModel<T extends Shark> extends EntityModel<T> {
	...
	public SharkModel() {
		...
		tail_fin.setTextureOffset(19, 20).addBox(-5.0F, -0.5F, -1.0F, 10.0F, 1.0F, 6.0F, 0.0F, false);
		...
		back_fin.setTextureOffset(51, 0).addBox(-0.5F, -0.75F, -0.5F, 1.0F, 4.0F, 5.0F, 0.0F, false);

		left_fin = new ModelRenderer(this);
		left_fin.setRotationPoint(3.0F, -2.0F, 5.0F);
		body.addChild(left_fin);
		setRotationAngle(left_fin, 0.9599F, 0.0F, 1.8675F);
		left_fin.setTextureOffset(48, 20).addBox(0.0F, -4.0F, -1.5F, 1.0F, 4.0F, 7.0F, 0.0F, false);

		right_fin = new ModelRenderer(this);
		right_fin.setRotationPoint(-3.0F, -2.0F, 5.0F);
		body.addChild(right_fin);
		setRotationAngle(right_fin, 0.9599F, 0.0F, -1.8675F);
		right_fin.setTextureOffset(48, 20).addBox(-1.0F, -4.0F, -1.5F, 1.0F, 4.0F, 7.0F, 0.0F, true);
	}
