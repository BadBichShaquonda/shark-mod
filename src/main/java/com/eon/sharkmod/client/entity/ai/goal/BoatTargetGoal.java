...
public class BoatTargetGoal extends Goal {
	...
	public BoatTargetGoal(MobEntity mobIn, boolean checkSight) {
	      this(mobIn, checkSight, false);
	   }

	public BoatTargetGoal(MobEntity mobIn, boolean checkSight, boolean nearbyOnlyIn) {
	...
	public BoatTargetGoal setUnseenMemoryTicks(int unseenMemoryTicksIn) {
